...
class TeamBallControlDrawer:
    ...
    def draw_frame(self, frame, frame_num, team_ball_control):
        ...
        team_ball_controll_till_frame = team_ball_control[:frame_num+1]
        ...
        team_1 = team_1_num_frames/(team_ball_controll_till_frame.shape[0])
        team_2 = team_2_num_frames/(team_ball_controll_till_frame.shape[0])
