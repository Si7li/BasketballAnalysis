...
class TacticalViewDrawer:
    def __init__(self,team_1_color=[255,245,238],team_2_color=[128,0,0]):
        self.start_x=20
        self.start_y=40
        self.team_1_color = (0,0,255)
        self.team_2_color = (255,0,0)

    def draw(self,video_frames,court_image_path,width,height,tactical_court_keypoints,tactical_player_positions,player_assignment=None,ball_aquisition_point=None):
        ...
        for frame_idx, frame in enumerate(video_frames):
            ...
            for key_point_index, keypoint in enumerate(tactical_court_keypoints):
                ...
                cv2.putText(frame,str(key_point_index),(x,y),cv2.FONT_HERSHEY_SIMPLEX,0.5,(255,255,255),2)

                frame_positions = tactical_player_positions[frame_idx]
                frame_assignment = player_assignment[frame_idx]
                player_with_ball = ball_aquisition_point[frame_idx]
